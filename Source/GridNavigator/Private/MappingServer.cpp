...
TArray<NavGrid::FNode> FMappingServer::GetMapNodeList()
{
	return Map.GetNodeList();
}

TArray<NavGrid::FEdge> FMappingServer::GetMapEdgeList()
{
	return Map.GetEdgeList();
}

std::optional<std::reference_wrapper<const NavGrid::FNode>> FMappingServer::GetNode(const NavGrid::FNode::ID ID)
{
